...
folderModelOut = join(plots_out, "Mitre_model")
data_out = join(dir, "..\\", "tabelas")
data1 = "19-06-2024"
data2 = "20-06-2024"
plots_made = {2: True, 4: False, 5: False, 6: False}
solutions = [
    f"sol_Mitre_freqconst_S1_{data2}.pickle",
    f"sol_Mitre_freqNconst_S1_{data2}.pickle",
    f"sol_Mitre_freqconst_S3_{data2}.pickle",
