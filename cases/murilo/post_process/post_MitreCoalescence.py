...
SOLUTION_NAME = "MitreCoalescence"
MODELO = "Mitre_CCE_CEM_Coalescence"
VALVULA = "MV01"
IGNORAR_TESTES = [88]
data1 = "03-12-2024"
data2 = "03-12-2024"
...
solutions = {
    f"sol_Mitre_{VALVULA}_C_CCE_S1_{data2}.pickle": "CCE S1",
    f"sol_Mitre_{VALVULA}_C_CCE_S3_{data2}.pickle": "CCE S3",
    f"sol_Mitre_{VALVULA}_C_CEM_S1_{data2}.pickle": "CEM S1",
}
solutions_otimizado = {
    # f"sol_C&T_murilo_{VALVULA}_{data2}.pickle": "CT opt",
}
solutions_convergencia_tempo = {
    f"sol_Mitre_{VALVULA}_C_CEM_5ts_{data1}.pickle": "CEM",  # 14
    f"sol_Mitre_{VALVULA}_C_CEM_10ts_{data1}.pickle": "CEM",
    f"sol_Mitre_{VALVULA}_C_CEM_20ts_{data1}.pickle": "CEM",
    f"sol_Mitre_{VALVULA}_C_CEM_40ts_{data1}.pickle": "CEM",
    f"sol_Mitre_{VALVULA}_C_CEM_50ts_{data1}.pickle": "CEM",
    f"sol_Mitre_{VALVULA}_C_CEM_70ts_{data1}.pickle": "CEM",
    f"sol_Mitre_{VALVULA}_C_CEM_100ts_{data1}.pickle": "CEM",
    f"sol_Mitre_{VALVULA}_C_CEM_150ts_{data1}.pickle": "CEM",  # 21
}

solutions_convergencia_volume = {
    f"sol_Mitre_{VALVULA}_C_CEM_0.1D_{data1}.pickle": "CEM",  # 4
    f"sol_Mitre_{VALVULA}_C_CEM_0.5D_{data1}.pickle": "CEM",
    f"sol_Mitre_{VALVULA}_C_CEM_1D_{data1}.pickle": "CEM",
    f"sol_Mitre_{VALVULA}_C_CEM_2D_{data1}.pickle": "CEM",
    f"sol_Mitre_{VALVULA}_C_CEM_2.4D_{data1}.pickle": "CEM",
    f"sol_Mitre_{VALVULA}_C_CEM_3D_{data1}.pickle": "CEM",
    f"sol_Mitre_{VALVULA}_C_CEM_4D_{data1}.pickle": "CEM",
    f"sol_Mitre_{VALVULA}_C_CEM_5D_{data1}.pickle": "CEM",
    f"sol_Mitre_{VALVULA}_C_CEM_6D_{data1}.pickle": "CEM",
    f"sol_Mitre_{VALVULA}_C_CEM_7D_{data1}.pickle": "CEM",  # 13
    f"sol_Mitre_{VALVULA}_C_CEM_8D_{data1}.pickle": "CEM",
    f"sol_Mitre_{VALVULA}_C_CEM_10D_{data1}.pickle": "CEM",
    f"sol_Mitre_{VALVULA}_C_CEM_15D_{data1}.pickle": "CEM",
}
