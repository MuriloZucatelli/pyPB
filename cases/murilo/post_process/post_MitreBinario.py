...
solutions = {
    f"sol_Mitre_{VALVULA}_CCE_{SOLUTION_NAME}_S1_{data2}.pickle": "CCE S1",
    f"sol_Mitre_{VALVULA}_CCE_{SOLUTION_NAME}_S3_{data2}.pickle": "CCE S3",
    f"sol_Mitre_{VALVULA}_CEM_{SOLUTION_NAME}_S1_{data2}.pickle": "CEM S1",
}
solutions_otimizado = {
    # f"sol_C&T_murilo_{VALVULA}_{data2}.pickle": "CT opt",
}
solutions_convergencia_tempo = {
    f"sol_Mitre_{VALVULA}_CEM_{SOLUTION_NAME}_5ts_{data1}.pickle": "CEM",  # 14
    f"sol_Mitre_{VALVULA}_CEM_{SOLUTION_NAME}_10ts_{data1}.pickle": "CEM",
    f"sol_Mitre_{VALVULA}_CEM_{SOLUTION_NAME}_20ts_{data1}.pickle": "CEM",
    f"sol_Mitre_{VALVULA}_CEM_{SOLUTION_NAME}_40ts_{data1}.pickle": "CEM",
    f"sol_Mitre_{VALVULA}_CEM_{SOLUTION_NAME}_50ts_{data1}.pickle": "CEM",
    f"sol_Mitre_{VALVULA}_CEM_{SOLUTION_NAME}_70ts_{data1}.pickle": "CEM",
    f"sol_Mitre_{VALVULA}_CEM_{SOLUTION_NAME}_100ts_{data1}.pickle": "CEM",
    f"sol_Mitre_{VALVULA}_CEM_{SOLUTION_NAME}_150ts_{data1}.pickle": "CEM",  # 21
}

solutions_convergencia_volume = {
    f"sol_Mitre_{VALVULA}_CEM_{SOLUTION_NAME}_0.1D_{data1}.pickle": "CEM",  # 4
    f"sol_Mitre_{VALVULA}_CEM_{SOLUTION_NAME}_0.5D_{data1}.pickle": "CEM",
    f"sol_Mitre_{VALVULA}_CEM_{SOLUTION_NAME}_1D_{data1}.pickle": "CEM",
    f"sol_Mitre_{VALVULA}_CEM_{SOLUTION_NAME}_2D_{data1}.pickle": "CEM",
    f"sol_Mitre_{VALVULA}_CEM_{SOLUTION_NAME}_2.4D_{data1}.pickle": "CEM",
    f"sol_Mitre_{VALVULA}_CEM_{SOLUTION_NAME}_3D_{data1}.pickle": "CEM",
    f"sol_Mitre_{VALVULA}_CEM_{SOLUTION_NAME}_4D_{data1}.pickle": "CEM",
    f"sol_Mitre_{VALVULA}_CEM_{SOLUTION_NAME}_5D_{data1}.pickle": "CEM",
    f"sol_Mitre_{VALVULA}_CEM_{SOLUTION_NAME}_6D_{data1}.pickle": "CEM",
    f"sol_Mitre_{VALVULA}_CEM_{SOLUTION_NAME}_7D_{data1}.pickle": "CEM",  # 13
    f"sol_Mitre_{VALVULA}_CEM_{SOLUTION_NAME}_8D_{data1}.pickle": "CEM",
    f"sol_Mitre_{VALVULA}_CEM_{SOLUTION_NAME}_10D_{data1}.pickle": "CEM",
    f"sol_Mitre_{VALVULA}_CEM_{SOLUTION_NAME}_15D_{data1}.pickle": "CEM",
}
...
if plots2made["Erro_X_Teste"]:
    ...
    error_x_(
        ...
        hue="Nome",
        style="Nome",
        xlabel="Concentração de água [-]",   #$\phi$
        ylabel=f"Erro relativo {VALVULA} " + r"$\psi$ \% ",
    )
