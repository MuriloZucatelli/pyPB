...
solutions_convergencia_tempo = [
    # f"sol_{SOLUTION_NAME}_5ts_{data1}.pickle",  # 0
    # f"sol_{SOLUTION_NAME}_10ts_{data1}.pickle",
    # f"sol_{SOLUTION_NAME}_20ts_{data1}.pickle",
    # f"sol_{SOLUTION_NAME}_40ts_{data1}.pickle",
    # f"sol_{SOLUTION_NAME}_50ts_{data1}.pickle",
    # f"sol_{SOLUTION_NAME}_70ts_{data1}.pickle",
    # f"sol_{SOLUTION_NAME}_100ts_{data1}.pickle",
    # f"sol_{SOLUTION_NAME}_150ts_{data1}.pickle",
]
solutions_convergencia_volume = [
    # f"sol_{SOLUTION_NAME}_0.1D_{data1}.pickle",
    # f"sol_{SOLUTION_NAME}_0.5D_{data1}.pickle",
    # f"sol_{SOLUTION_NAME}_1D_{data1}.pickle",  # 10
    # f"sol_{SOLUTION_NAME}_2D_{data1}.pickle",
    # f"sol_{SOLUTION_NAME}_2.4D_{data1}.pickle",
    # f"sol_{SOLUTION_NAME}_3D_{data1}.pickle",
    # f"sol_{SOLUTION_NAME}_4D_{data1}.pickle",
    # f"sol_{SOLUTION_NAME}_5D_{data1}.pickle",
    # f"sol_{SOLUTION_NAME}_6D_{data1}.pickle",
    # f"sol_{SOLUTION_NAME}_7D_{data1}.pickle",
    # f"sol_{SOLUTION_NAME}_8D_{data1}.pickle",
    # f"sol_{SOLUTION_NAME}_10D_{data1}.pickle",
    # f"sol_{SOLUTION_NAME}_15D_{data1}.pickle",  # 20
]
#
#
# Plot:
